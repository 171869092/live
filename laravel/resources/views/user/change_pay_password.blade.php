...
<div class="main-container">
    <div class="common-container">
        ...
        <div id="account-container">
            ...
            <form action="/sells/accounts/add_pay_password" accept-charset="UTF-8" method="post">
                <input name="utf8" type="hidden" value="✓" />
                <input type="hidden" name="authenticity_token" value="/ib/F2m8tpdnPA6bAJSAgmZNzwvBPrGNWYQ/aTmN55MCi+rwZndr7oL/G2ImguVFdtmJLHVQF9sJePscrMVeEw==" />
                <div class="security-tr">
                    <div class="left">
                        新密码
                    </div>
                    <input type="password" name="password" id="password" placeholder="由6位数字组成" />
                </div>
                <div class="security-tr">
                    <div class="left">
                        确认新密码
                ...
                <div class="submit_btn">
                    <input type="submit" name="commit" value="保存" class="save" />
                </div>
            </form>
        </div>
    </div>
