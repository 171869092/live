...
<body data-current_user="true" data-exchange_rate="6.87" data-user_status="2" id="sells_users_index">
<nav class="left_sidebar">
    ...
    <div class="option-box hover-box">
        <a href="javascript:void(0);">
            <img src="https://cdn-resources-aliyun.kjds.com/assets/sells/users/icon10-5c2866878238693b4f1598fc2a3af3e8.png" alt="Icon10" />
            <div class="name"> 账号授权</div></a>
        <div class="hide-box">
            <div class="each-item">
    ...
    <!--一件刊登 开始-->
    <div class="option-box hover-box">
        <a href="../publish/products.html">
            <img src="https://cdn-resources-aliyun.kjds.com/assets/sells/users/icon2-1eff06d5ed25119d8303581f95aa5aa8.png" alt="Icon2" />
            <div class="name">一键刊登</div>
        </a>
        <div class="hide-box">
            <div class="each-item">
    ...
    <div class="option-box hover-box">
        <a href="../inventories/inventories.html">
            <img src="https://cdn-resources-aliyun.kjds.com/assets/sells/users/icon2-1eff06d5ed25119d8303581f95aa5aa8.png" alt="Icon2" />
            <div class="name"> 库存预警</div></a>
    </div>

    <!--订单管理 开始-->
    <div class="option-box hover-box">
        <a href="../orders/orders_search.html">
            <img src="https://cdn-resources-aliyun.kjds.com/assets/sells/users/icon3-7ef36eb63ff68c53ba11e47b70cba6f1.png" alt="Icon3" />
            <div class="name">
                订单管理
            </div>
        </a>
...
<div class="main-container">
    <div class="common-container"><div class="top">我的基本信息</div><div id="account-container"><div class="top">账户安全中心 &gt;<span>修改手机号</span></div><form class="edit_user" id="edit_user_19103" action="/sells/users/19103" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="✓"><input type="hidden" name="_method" value="patch"><input type="hidden" name="authenticity_token" value="ANRI04/N4Cd+sXX78ss+rJqFgCEzCFzYJs+vpRwVtTj8eV00gAY9XptyYALU3VtrihHGBodm+o52M2vQiV0MuA=="><div class="security-tr"><div class="left">已绑定手机</div><input disabled="" type="text" value="13303461223"></div><div class="security-tr"><div class="left">新手机</div><input type="text" name="phone" id="phone" placeholder="请输入您的手机号"><div class="change-btn send_code">获取验证码</div></div><div class="security-tr"><div class="left">验证码</div><input type="text" name="captcha" id="captcha" placeholder="请输入验证码" disabled="disabled"></div><div class="submit_btn"><input type="submit" name="commit" value="确定修改" class="save"></div></form></div></div>
</div>
<footer>
    <div class="container">
