...
<body data-current_user="true" data-exchange_rate="6.87" data-user_status="2" id="sells_users_subscribe">
<nav class="left_sidebar">
    ...
    <div class="option-box hover-box">
        <a href="basic_msg.html"><img src="https://cdn-resources-aliyun.kjds.com/assets/user_default_avatar-4e570b12afe281b3e0cee7b2079e8abc.png" alt="User default avatar" />
            <div class="name">
                个人中心
            </div></a>
        <div class="hide-box">
            <div class="each-item">
                <a href="basic_msg.html">基本资料</a>
            </div>
            <div class="each-item">
...
<div class="main-container">
    <ul class="top_tab clear">
        <li class="hot_subscription active">热销和新品订阅</li>
    </ul>
    <div class="subscription_wrap">
        <div class="hot_subscription">
            <div class="current_category_wrap" seq="1">
                <div class="title">
                    已订阅品类
                    <p>温馨提示：每周一次为您推送热销商品和新品，默认推荐您注册时所选择的主营品类，您可以自行修改订阅类目。</p>
                </div>
                <div class="current_category_main clear">
                    <div class="btn-group own_btn-group" id="firstLevel">
                        <button aria-expanded="false" aria-haspopup="true" class="btn own_btn dropdown-toggle" data-toggle="dropdown" type="button"><span class="text text_limit phcolor">一级品类</span><span class="glyphicon glyphicon-menu-down"></span></button>
                        <ul class="dropdown-menu own_dropdown-menu">
                            <li><a data-id="39568" href="javascript:void(0);">假发</a></li>
                            <li><a data-id="36609" href="javascript:void(0);">婚礼及重要场合</a></li>
                            <li><a data-id="36608" href="javascript:void(0);">手表</a></li>
                            <li><a data-id="36596" href="javascript:void(0);">照明灯饰</a></li>
                            <li><a data-id="36588" href="javascript:void(0);">电子元器件</a></li>
                            <li><a data-id="36597" href="javascript:void(0);">箱包</a></li>
                            <li><a data-id="36592" href="javascript:void(0);">家居用品</a></li>
                            <li><a data-id="36586" href="javascript:void(0);">电脑和办公</a></li>
                            <li><a data-id="36606" href="javascript:void(0);">玩具</a></li>
                            <li><a data-id="36605" href="javascript:void(0);">工具</a></li>
                            <li><a data-id="36598" href="javascript:void(0);">孕婴童</a></li>
                            <li><a data-id="36582" href="javascript:void(0);">服装/服饰配件</a></li>
                            <li><a data-id="36600" href="javascript:void(0);">电话和通讯</a></li>
                            <li><a data-id="36599" href="javascript:void(0);">办公文教用品</a></li>
                            <li><a data-id="36602" href="javascript:void(0);">鞋子</a></li>
                            <li><a data-id="36604" href="javascript:void(0);">运动及娱乐</a></li>
                            <li><a data-id="36594" href="javascript:void(0);">家装（硬装）</a></li>
                            <li><a data-id="36587" href="javascript:void(0);">消费电子</a></li>
                            <li><a data-id="36595" href="javascript:void(0);">珠宝饰品及配件</a></li>
                            <li><a data-id="36593" href="javascript:void(0);">家用电器</a></li>
                            <li><a data-id="36590" href="javascript:void(0);">家具和室内装饰品</a></li>
                            <li><a data-id="36584" href="javascript:void(0);">美容健康</a></li>
                            <li><a data-id="36583" href="javascript:void(0);">汽车、摩托车</a></li>
                            <li><a data-id="36601" href="javascript:void(0);">安全防护</a></li>
                            <li><a data-id="36591" href="javascript:void(0);">假发及周边</a></li>
                        </ul>
                    </div>
                    <div class="btn-group own_btn-group" id="secondLevel">
                        <button aria-expanded="false" aria-haspopup="true" class="btn own_btn dropdown-toggle" data-toggle="dropdown" type="button"><span class="text text_limit phcolor">二级品类</span><span class="glyphicon glyphicon-menu-down"></span></button>
                        <ul class="dropdown-menu own_dropdown-menu"></ul>
                    </div>
                    <div class="choosen_category">
                        <span class="a_category" data-id="34087"><span class="text">急救箱</span><i class="glyphicon glyphicon-remove-circle"></i></span>
                        <span class="a_category" data-id="35149"><span class="text">儿童家具</span><i class="glyphicon glyphicon-remove-circle"></i></span>
                        <span class="a_category" data-id="35151"><span class="text">家具附件</span><i class="glyphicon glyphicon-remove-circle"></i></span>
                        <span class="a_category" data-id="36424"><span class="text">电脑清洁用品</span><i class="glyphicon glyphicon-remove-circle"></i></span>
                    </div>
                    <p>* 已选分类</p>
                </div>
                <button class="subscribe active"></button>
            </div>
            <ul class="email_subscription">
                <li seq="1"><input old_email="" placeholder="请输入您的订阅邮箱" readonly="readonly" type="text" value="work_wang1989@163.com" /><a class="modify"><span></span>编辑</a><a class="remove"><span></span>删除</a><a class="add"><span></span>添加</a><a class="save">保存</a></li>
            </ul>
        </div>
        <div class="layer">
            <div class="layer_box">
                ...
                <div class="layer_main">
                    <div class="remove_alert">
                        <p>您没有填写邮箱地址，无法收到已选择品类下的新品和热销商品。确定删除吗？</p>
                    </div>
                    <div class="add_category_alert">
                        <p>订阅数不能超过5项</p>
                    </div>
                    <div class="add_email_alert">
                        <p>邮箱地址不能超过5个</p>
                    </div>
                    <div class="cancle_alert">
                        <p>您确定要取消订阅吗?</p>
                        <p>取消后您将不再收到推送邮件。</p>
                    </div>
