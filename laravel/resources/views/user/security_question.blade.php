...
<body data-current_user="true" data-exchange_rate="6.87" data-user_status="2" id="sells_users_change_security_question">
<nav class="left_sidebar">
    ...
    <div class="option-box hover-box">
        <a href="/sells/users"><img src="https://cdn-resources-aliyun.kjds.com/assets/user_default_avatar-4e570b12afe281b3e0cee7b2079e8abc.png" alt="User default avatar" />
...
<div class="main-container">
    <div class="common-container">
        ...
        <div data-action="new" id="account-container">
            <div class="top">
                账户安全中心 &gt;
                <span>安全问题设置</span>
            </div>
            <form action="/sells/users/update_security_question" accept-charset="UTF-8" method="post">
                <input name="utf8" type="hidden" value="✓" />
                <input type="hidden" name="authenticity_token" value="bLu4L5nKUt7dggtVFzrBxvUIU+94iH7sCH9cjx2z/buQFq3IlgGPpzhBHqwxLKQB5ZwVyMzm2LpYg5j6iPtEOw==" />
                <input type="hidden" name="security_problems" id="security_problems" />
                <div class="security-tr">
                    <div class="left">
                        安全问题1
                    </div>
                    <div class="select">
                        ...
                        <div class="slide-down">
                            <img src="https://cdn-resources-aliyun.kjds.com/assets/sells/users/slide-down-42a48652ecf261999c4d6894edfb8802.png" alt="Slide down" />
                        </div>
                        <div class="hide-box">
                            ...
                            <div class="option" data-id="6">
                                您的大学校名是什么？
                            </div>
                            <div class="option" data-id="7">
                                您最喜欢的菜是什么？
                            </div>
                            <div class="option" data-id="8">
                                您最喜欢的动物是什么？
                            </div>
                            <div class="option" data-id="9">
                                您最喜欢哪个季节？
                            </div>
                            <div class="option" data-id="10">
                                您的妈妈叫什么名字？
                            </div>
                            <div class="option" data-id="16">
                                您最喜爱的电影是什么？
                            </div>
                            <div class="option" data-id="14">
                                您最喜欢的NBA球星是谁？
                            </div>
                            <div class="option" data-id="15">
                                您最想去的国家是哪个？
                            </div>
                        </div>
                    </div>
                </div>
                <div class="security-tr answer">
                    <div class="left">
                        输入答案
                    </div>
                ...
                <div class="save-to-change">
                    <input type="submit" name="commit" value="确定修改" />
                </div>
            </form>
        </div>
    </div>
