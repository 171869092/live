...
<body data-current_user="true" data-exchange_rate="6.87" data-user_status="2" id="sells_users_custom">
...
<div class="main-container">
    <div class="common-container">
        ...
        <div id="account-container">
            ...
            <form class="edit_shop_setting" id="edit_shop_setting_18142" action="/sells/users/update_custom_value" accept-charset="UTF-8" method="post">
                <input name="utf8" type="hidden" value="✓" />
                <input type="hidden" name="authenticity_token" value="3WX/AReqi+TEXbta4rOPrqMmQqjszf0BYy43bgY4NkYhyOrmGGFWnSGerqPEpepps7IEj1ijW1cz0vMbk3CPxg==" />
                <div class="security-tr">
                    <div class="left">
                        页数
                    </div>
                    <input placeholder="默认值为10,最大为200" onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/D/g,'')}" onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/D/g,'')}" type="text" value="10" name="shop_setting[custom_value]" id="shop_setting_custom_value" />
                </div>
