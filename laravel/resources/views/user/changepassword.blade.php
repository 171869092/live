...
<div class="main-container">
    <div class="common-container">
        ...
        <div id="account-container">
            ...
            <form action="/users/reset_password" accept-charset="UTF-8" method="post">
                <input name="utf8" type="hidden" value="✓" />
                <input type="hidden" name="authenticity_token" value="BQF49iBeaR9+9bpeyqGocb1BG/CpXDPhutHhTpz9UVL5rG0RL5W0Zps2r6fst822rdVd1x0ylbfqLSU7CbXo0g==" />
                <div class="security-tr">
                    <div class="left">
                        旧密码
                    </div>
                    <input type="password" name="current_password" id="current_password" placeholder="请输入您的原始密码" />
                </div>
                <div class="security-tr">
                    <div class="left">
                        新密码
                    </div>
                    <input type="password" name="password" id="password" placeholder="由8-20位字符，建议字母、数字或符号两种以上组合" />
                </div>
                <div class="security-tr">
                    <div class="left">
                        确认新密码
