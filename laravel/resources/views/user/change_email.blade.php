...
<div class="main-container">
    <div class="common-container">
        ...
        <div id="account-container">
            ...
            <form class="edit_user" id="edit_user_19103" action="/sells/users/19103" accept-charset="UTF-8" method="post">
                <input name="utf8" type="hidden" value="✓" />
                <input type="hidden" name="_method" value="patch" />
                <input type="hidden" name="authenticity_token" value="hA3lCG54fF0pqcFenS33KtSNDTYNYteV4nJaswQIyUV4oPDvYbOhJMxq1Ke7O5LtxBlLEbkMccOyjp7GkUBwxQ==" />
                <div class="security-tr">
                    <div class="left">
                        已绑定邮箱
                    </div>
                    <input disabled="" type="text" value="work_wang1989@163.com" />
                </div>
                <div class="security-tr">
                    <div class="left">
                        新邮箱
                    ...
                    <div class="change-btn send_code">
                        获取验证码
                    </div>
                </div>
                <div class="security-tr">
                    ...
                    <input type="text" name="captcha" id="captcha" placeholder="请输入验证码" disabled="disabled" />
                </div>
                <div class="submit_btn">
                    <input type="submit" name="commit" value="确定修改" class="save" />
                </div>
            </form>
        </div>
    </div>
