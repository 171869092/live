...
<body data-current_user="true" data-exchange_rate="6.87" data-user_status="2" id="sells_users_account_security">
    ...
    <div class="common-container">
        ...
        <div id="account-container">
            ...
            <div class="security-tr">
                ...
                <input disabled="disabled" type="text" value="work_wang1989@163.com" />
                <a class="change-btn" href="{{ url('channgeEmail', '') }}">修改邮箱</a>
            </div>
            <div class="security-tr">
                <div class="left">
                    手机
                </div>
                <input disabled="disabled" type="text" value="13303461223" />
                <a class="change-btn" href="{{ url('channgePhone', '') }}">修改绑定</a>
            </div>
            <div class="security-tr">
                <div class="left">
                    登录密码
                ...
                <a class="change-btn" href="{{ url('channgePwd', '') }}">修改登录密码</a>
            </div>
            <div class="security-tr">
                <div class="left">
                    支付密码
                ...
                <input disabled="disabled" type="text" value="*********" />
                <a class="change-btn" href="{{ url('addPayPwd', '') }}">添加支付密码</a>
            </div>
            <div class="security-tr">
                <a class="change-btn add-question" href="{{ url('safetyQuestion', '') }}">添加安全问题</a>
            </div>
        </div>
    </div>
</div>
