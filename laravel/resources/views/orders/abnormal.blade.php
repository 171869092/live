...
<body data-current_user="true" data-exchange_rate="6.87" data-user_status="2" id="sells_orders_abnormal_order">
...
<div class="main-container">
    <div class="center-container">
        ...
        <div class="top-search">
            <form class="order_search" id="order_search" action="/sells/orders/abnormal_order" accept-charset="UTF-8" method="get">
                <input name="utf8" type="hidden" value="✓" />
                <input id="condition" name="" type="hidden" />
                <div class="each-row">
                    <div class="condition-choose">
                        <div class="btn-group own_btn-group">
                            <div class="own_btn dropdown-toggle" data-toggle="dropdown">
                                <span class="text text_limit">请选择</span>
                                <span class="glyphicon glyphicon-chevron-down"></span>
                            </div>
                            <ul class="dropdown-menu">
                                <li><a value="order_number_cont">订单编号</a></li>
                                <li><a value="import_order_number_eq">B2C订单号</a></li>
                                <li><a value="b2c_order_b2c_order_id_eq">原始订单号</a></li>
                                <li><a value="shipping_number_or_shipping_waybill_records_number_eq">运单号</a></li>
                                <li><a value="order_items_inventory_sku_art_no_cont">原始货号</a></li>
                                <li><a value="order_items_order_snap_item_product_name_cont">商品名称</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="platform">
                        <span>平台</span>
                        <div class="btn-group own_btn-group">
                            <button aria-expanded="false" aria-haspopup="true" class="btn own_btn dropdown-toggle" data-toggle="dropdown" type="button"><input type="hidden" name="q[b2c_platform_id_eq]" id="q_b2c_platform_id_eq" /><span class="text text_limit phcolor">全部</span><span class="glyphicon glyphicon-menu-down pull-right"></span></button>
                ...
                <div class="each-row">
                    <div class="pay_time">
                        ...
                        <div class="time_interval">
                            <div class="time_start time">
                                <input placeholder="起始时间" id="datepicker-s" class="date_input" data-date-format="yyyy-mm-dd" type="search" name="q[created_at_gteq]" />
                                <div class="icon-box">
                                    <i class="glyphicon glyphicon-calendar"></i>
                                </div>
                            </div>—
                            <div class="time_end time">
                                <input placeholder="结束时间" id="datepicker-e" class="date_input" data-date-format="yyyy-mm-dd" type="search" name="q[created_at_lteq]" />
                                <div class="icon-box">
                                    <i class="glyphicon glyphicon-calendar"></i>
                                </div>
                            </div>
                    ...
                    <div class="reason">
                        <span>异常原因</span>
                        <div class="btn-group own_btn-group">
                            <button aria-expanded="false" aria-haspopup="true" class="btn own_btn dropdown-toggle" data-toggle="dropdown" type="button"><input type="hidden" name="q[shipping_status_eq]" id="q_shipping_status_eq" /><span class="text text_limit phcolor">全部</span><span class="glyphicon glyphicon-menu-down pull-right"></span></button>
                            <ul class="dropdown-menu own_dropdown-menu">
                                <li><a data-id="">全部</a></li>
                                <li><a data-value="商品已下架" href="javascript:void(0);">商品已下架</a></li>
                                <li><a data-value="缺少地址" href="javascript:void(0);">缺少地址</a></li>
                                <li><a data-value="售价不符" href="javascript:void(0);">售价不符</a></li>
                                <li><a data-value="商品物流不支持" href="javascript:void(0);">商品物流不支持</a></li>
                                <li><a data-value="收货地物流不支持" href="javascript:void(0);">收货地物流不支持</a></li>
                                <li><a data-value="库存SKU已下架" href="javascript:void(0);">库存SKU已下架</a></li>
                                <li><a data-value="商品和收货地物流不匹配" href="javascript:void(0);">商品和收货地物流不匹配</a></li>
                                <li><a data-value="特殊属性物流不支持" href="javascript:void(0);">特殊属性物流不支持</a></li>
                                <li><a data-value="运费异常" href="javascript:void(0);">运费异常</a></li>
                                <li><a data-value="无法生成运单号" href="javascript:void(0);">无法生成运单号</a></li>
                                <li><a data-value="无法打印运单" href="javascript:void(0);">无法打印运单</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="each-row contain-float"></div>
                <div class="search-btn">
                    <i class="glyphicon glyphicon-search"></i>
                    <input type="submit" name="commit" value="开始查询" />
                </div>
            </form>
        </div>
        <div class="sell_order_list">
            <table class="table order-table">
                <thead>
                <tr>
                    <th class="check-selection"></th>
                    <th class="product-info">商品信息</th>
                    <th class="price-number">单价 x 数量</th>
                    <th>总价</th>
                    <th>订单状态</th>
                    <th>平台</th>
                    <th>操作</th>
...
<div class="modal fade" id="edit_order_state">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <h3 class="select-tips">修改订单状态：</h3>
                <div class="state-edit">
                    <input class="order_status" type="hidden" />
                    <span>订单状态：</span>
                    <div class="btn-group own_btn-group">
                        <button class="btn own_btn dropdown-toggle" data-toggle="dropdown" type="button"><span class="text text_limit phcolor">待付款</span><span class="glyphicon glyphicon-menu-down pull-right"></span></button>
                        <ul class="dropdown-menu own_dropdown-menu">
                            <li><a data-option="waiting_payment">待付款</a></li>
                            <li><a data-option="cancelled">已取消</a></li>
                        </ul>
                    </div>
                </div>
                <div class="btn-area">
                    <a class="confirm" data-dismiss="modal">确定</a>
