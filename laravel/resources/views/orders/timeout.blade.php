...
<body data-current_user="true" data-exchange_rate="6.87" data-user_status="2" id="sells_orders_overtime_order">
...
<div class="main-container">
    <div class="center-container">
        ...
        <div class="top-search">
            <form class="order_search" id="order_search" action="/sells/orders/overtime_order" accept-charset="UTF-8" method="get">
                    ...
                    <div class="reason">
                        ...
                        <div class="btn-group own_btn-group">
                            ...
                            <ul class="dropdown-menu own_dropdown-menu">
                                ...
                                <li><a data-value="未打印订单" href="javascript:void(0);">未打印订单</a></li>
                                <li><a data-value="无物流信息" href="javascript:void(0);">无物流信息</a></li>
                                <li><a data-value="未填写运单号" href="javascript:void(0);">未填写运单号</a></li>
                                <li><a data-value="未及时发货" href="javascript:void(0);">未及时发货</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="overtime-reason">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <h3 class="select-tips">超时原因：</h3>
                ...
                <div class="btn-area">
                    <a class="close-btn" data-dismiss="modal">关闭</a>
                </div>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="fill-in-order-list">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <h4>手工回填运单</h4>
                <div class="content-box">
                    <span>快递单号</span>
                    <textarea placeholder="请输入您的手工回填运单号"></textarea>
                </div>
                <div class="btn-area">
                    <a class="confirm" data-dismiss="modal">确定发货</a>
