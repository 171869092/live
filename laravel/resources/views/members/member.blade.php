...
<body data-current_user="true" data-exchange_rate="6.87" data-user_status="2" id="sells_members_index">
<nav class="left_sidebar">
    ...
    <div class="option-box hover-box">
        <a href="members.html"><img src="https://cdn-resources-aliyun.kjds.com/assets/member_icon-954804cff28697bdf9dae6fc05f81426.png" alt="Member icon" />
            <div class="name">
                我的会员
            </div></a>
    </div>
...
<div class="main-container">
    <div class="center-container">
        ...
        <div class="distributor_member_detail">
            <div class="row">
                <div class="left-label member-level-label">
                    <label>我的会员级别:</label>
                </div>
                <div class="right-content">
                    ...
                    <div class="member-subscription">
                        <a class="btn subscription-button" target="_blank" href="/sells/members/subscription">成为会员</a>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="right-content">
                    <div class="member-level check-member-permission">
                        <a class="check-senior-info" href="/sells/propagation_activities/member_propagation" target="_blank">查看会员权限</a>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="right-content">
                    <div class="member-level check-shop-log">
                        <a data-toggle="modal" data-target="#recharge-histories" target="_blank" data-remote="true" href="/sells/members/member_recharge_histories">查看购买记录</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="recharge-histories"></div>
<footer>
    <div class="container">
