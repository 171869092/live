...
<head>
    ...
    <![endif]-->
    <title>eBay物流模板</title>
</head>
<body data-current_user="true" data-exchange_rate="6.87" data-user_status="2" id="freight_templates_template_new">
<nav class="left_sidebar">
    ...
    <div class="option-box hover-box">
        <a href="products.html"><img src="https://cdn-resources-aliyun.kjds.com/assets/sells/users/icon2-1eff06d5ed25119d8303581f95aa5aa8.png" alt="Icon2" />
            <div class="name">
                一键刊登
            </div></a>
        <div class="hide-box">
            <div class="each-item">
                <a href="products.html">我的刊登商品</a>
            </div>
            <div class="each-item">
                <a href="freight_templates.html">eBay物流模板</a>
            </div>
        </div>
    </div>
    <div class="option-box hover-box">
...
<div class="main-container">
    ...
    <div class="content-body">
        <table>
            ...
            <tbody>
            <tr>
                <td class="td10">eBay</td>
                <td class="td15">2019-03-26 17:54:20</td>
                <td class="td65">123</td>
                <td class="operate"><a class="edit" href="/freight_templates/7041/edit" target="_blank">编辑</a><span>|</span><a class="delete" data-id="7041" id="real">删除</a></td>
            </tr>
            </tbody>
        </table>
        <div class="btn-group">
            <a class="add" target="" href="add.html">新增</a>
        </div>
    </div>
</div>
<div aria-hidden="true" class="modal fade" id="pro-relation">
