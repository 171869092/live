...
<body data-current_user="true" data-exchange_rate="6.87" data-user_status="2" id="sells_b2c_platforms_auth_logistics">
<nav class="left_sidebar">
    ...
    <div class="option-box hover-box">
        ...
        <div class="hide-box">
            ...
            <div class="each-item">
                <a class="../orders/import_order" href="import_orders.html">批量下单</a>
            </div>
        </div>
    </div>
    <div class="option-box hover-box">
...
<div class="main-container">
    <div class="center-container">
        ...
        <div class="logistic-info">
            <div class="top_tip">
                <span>温馨提示：</span>
                <span class="warning-content">账号授权过期的账号无法正常获取面单，请在失效日期之前重新授权WISH邮账号</span>
            </div>
            <table>
                <thead>
                <tr>
                ...
                <tr>
                    <td>wish邮</td>
                    <td><a target="_blank" href="https://www.kjds.com/sells/customer_services/55">查看授权帮助</a></td>
                    <td></td>
                    <td>--</td>
                    <td>--</td>
                    <td class="operate"><a class="add">添加授权</a></td>
                </tr>
                </tbody>
            </table>
        </div>
...
<div class="modal fade" id="auth_logistics">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span><input class="hidden" id="account_id" /></button>
                <h4 class="modal-title">物流账号授权:</h4>
            </div>
            <div class="modal-body">
                <form>
                    <div class="well">
                        <h4 class="text-danger">温馨提示：</h4>
                        <h4 class="text-danger">1.申请wish邮ERP重定向URI是：</h4>
                        <h4 class="text-danger">https://www.kjds.com/sells/b2c_platforms/auth_wishpost_token</h4>
                        <h4 class="text-danger">2.一个Wish邮账号只能授权绑定一个越域大卖账号，不能授权多个越域大卖账号，否则无法获取运单号。</h4>
                        <h4 class="text-danger">3.Wish邮的账号授权有一定有效期，过期的账号无法获取面单，因此请关注越域大卖提醒信息，在有效期之前再次授权账号。</h4>
                    </div>
                    <div class="form-group">
                        <label class="control-label">客户端ID(wish邮中创建的app中的属性):<span class="text-muted">请确保填写正确,否则无法绑定账号。</span></label>
                        <input class="client_id form-control" placeholder="请输入您wish邮账号中APP的客户端ID" type="text" />
                    </div>
                    <div class="form-group">
                        <label class="control-label">客户端密钥(wish邮中创建的app中的属性):<span class="text-muted">请确保填写正确,否则无法绑定账号。</span></label>
                        <input class="client_secret form-control" placeholder="请输入您wish邮账号中APP的客户端密钥" type="text" />
                    </div>
