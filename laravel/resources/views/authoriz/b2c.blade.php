...
<body data-current_user="true" data-exchange_rate="6.87" data-user_status="2" id="sells_b2c_platforms_index">
<nav class="left_sidebar">
    ...
    <div class="option-box hover-box">
        ...
        <div class="hide-box">
            <div class="each-item">
                <a href="b2c.html">B2C账号授权</a>
            </div>
            <div class="each-item">
                <a href="auth_logistics.html">物流账号授权</a>
            </div>
        </div>
    </div>
    <div class="option-box hover-box">
...
<div class="main-container">
    <div class="license_wrap">
        <div class="eaby_id">
            <a class="add addEbay" data-platform_id="1" href="javascript:void(0);">+ 添加eBay账号</a>
            <table>
                <thead>
                <tr>
                    <th>eBay账号</th>
                ...
                <tbody data-bind="foreach: ebay_accounts"></tbody>
            </table>
        </div>
        <div class="wish_id">
            <a class="add addWish" data-platform_id="27" href="javascript:void(0);"> + 添加wish账号</a>
            <a class="wish_tips" href="//www.kjds.com/sells/customer_services/15" target="_blank">Wish平台账号绑定流程</a>
            <table>
                <thead>
                <tr>
                    <th>wish账号</th>
                ...
                <tbody data-bind="foreach: wish_accounts"></tbody>
            </table>
        </div>
    </div>
    <div class="modal fade" id="myeBayModal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="myModalLabel">请输入您想添加的账号:</h4>
                </div>
                <div class="modal-body">
                    <form>
                        <div class="well">
                            <h4 class="text-danger">温馨提示：</h4>
                            <h4 class="text-danger">1.eBay 店铺须首票订单产生后270天，才能使用第三方刊登软件。</h4>
                            <h4 class="text-danger">2.授权操作需要登录eBay页面。请到您的eBay账号常用电脑上操作，以防账号</h4>
                            <h4 class="text-danger">关联。</h4>
                        </div>
                        <div class="form-group">
                            <label class="control-label">eBay账号:<span class="text-muted">可以是非eBay账号名的任何名称，您只需要保证自己和同事都认识它。</span></label>
                            <input class="name form-control" placeholder="请输入您想添加的eBay账号" type="text" />
                        </div>
                        <div class="form-group">
                            <label class="control-label">账号名缩写:<span class="text-muted">2-3位的字母或数字，将用于系统中的简要展现。</span></label>
                            <input class="nameEn form-control" placeholder="请输入您的账号名缩写" type="text" />
                        </div>
                        <div class="form-group">
                            <label class="control-label">收款账号:<span class="text-muted">请确认Paypal账号已与对应的eBay做好关联,该账号将提供给eBay收取刊登费用，并接受买家的订单付款。</span></label>
                            <input class="collection form-control" placeholder="请输入您的收款账号" type="text" />
                        </div>
                        <div class="checkbox">
                            <label><input checked="" class="J_out_of_stock" type="checkbox" />开启eBay账号的Out-of-Stock属性，当商品数量为0时Listing不被eBay自动下架。</label>
                        </div>
                        <div class="checkbox must">
                            <label><input checked="" type="checkbox" />同意<a href="/clause.html" target="_blank">《越域大卖分销商合作协议》</a></label>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button class="btn btn_cancel" data-dismiss="modal" type="button">取消</button>
                    <button class="btn btn_save save" data-platform_id="1" type="button">保存</button>
                </div>
            </div>
        </div>
    </div>
    <div class="modal fade" data-auth_base_url="https://merchant.wish.com/oauth/authorize?client_id=" id="myWishModal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="my1ModalLabel">请输入您想添加的账号:</h4>
                </div>
                <div class="modal-body">
                    <form>
                        <div class="well">
                            <h4 class="text-danger">注意：授权操作需要登录Wish页面。请到您的Wish账号常用电脑上操作,以防账号关联;</h4>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Wish账号:<span class="text-muted">可以是非Wish账号名的任何名称，您只需要保证自己和同事都认识它。</span></label>
                            <input class="name form-control" placeholder="请输入您想添加的Wish账号" type="text" />
                        </div>
                        <div class="form-group">
                            <label class="control-label">账号名缩写:<span class="text-muted">2-3位的字母或数字，将用于系统中的简要展现。</span></label>
                            <input class="nameEn form-control" placeholder="请输入您的账号名缩写" type="text" />
                        ...
                        <div class="form-group">
                            <label class="control-label">client_id(wish中创建的app中的属性):<span class="text-muted">请确保填写正确,否则无法绑定账号。</span></label>
                            <input class="client_id form-control" placeholder="请输入您wish账号中APP的client_id" type="text" />
                        </div>
                        <div class="form-group">
                            <label class="control-label">client_secret(wish中创建的app中的属性):<span class="text-muted">请确保填写正确,否则无法绑定账号。</span></label>
                            <input class="client_secret form-control" placeholder="请输入您wish账号中APP的client_secret" type="text" />
                        </div>
                        <div class="checkbox must">
                            <label><input checked="" type="checkbox" />同意<a href="/clause.html" target="_blank">《越域大卖分销商合作协议》</a></label>
                        </div>
                ...
                <div class="modal-footer">
                    <button class="btn btn_cancel" data-dismiss="modal" type="button">取消</button>
                    <button class="btn btn_save save" data-platform_id="27" type="button">保存</button>
                </div>
            </div>
        </div>
    </div>
    <div class="modal fade" id="myShopeeModal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="myShopeeModalLabel">请输入您想绑定的账号:</h4>
                </div>
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            <label class="control-label">Shopee账号:<span class="text-muted">可以是非Shopee账号名的任何名称，您只需要保证自己和同事都认识它。</span></label>
                            <input class="name form-control" maxlength="25" placeholder="请输入您想添加的Shopee账号" type="text" />
                        </div>
                        <div class="form-group">
                            <label class="control-label">账号名缩写:<span class="text-muted">2-3位的字母或数字，将用于系统中的简要展现。</span></label>
                            <input class="nameEn form-control" maxlength="10" placeholder="请输入您的账号名缩写" type="text" />
                        </div>
                        <div class="checkbox must">
                            <label><input checked="" type="checkbox" />同意<a href="/clause.html" target="_blank">《越域大卖分销商合作协议》</a></label>
                        </div>
                ...
                <div class="modal-footer">
                    <button class="btn btn_cancel" data-dismiss="modal" type="button">取消</button>
                    <button class="btn btn_save save" data-dismiss="modal" data-platform_id="50" type="button">保存</button>
                </div>
            </div>
        </div>
    </div>
    <div class="modal fade" id="api-status-modal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="title">
                ...
                <div class="modal-footer">
                    <div class="btn-area">
                        <span class="btn cancel-btn" data-target="#api-status-modal" data-toggle="modal">关闭</span>
                    </div>
                </div>
            </div>
        </div>
